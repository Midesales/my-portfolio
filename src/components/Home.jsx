      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full">
        <div className="p-2 text-left">
          <h1 className="text-lg lg:text-4xl font-bold text-pink-100">
            Hi, I'm{" "}
            <span className="text-sm md:text-xl lg:text-3xl tracking-wider">
              Ayomide Adeagbo
            </span>
          </h1>
          ...
          <h2 className="lg:max-w-[600px] text-left pt-2">
            ...
            proficiency in React and Tailwind CSS allows me to specialize in
            crafting user-friendly and visually appealing web applications.
          </h2>
        ...
        <div className="">
          <img src={Ayo} alt="ayo" className=" w-80 rounded-full" />
        </div>
      </div>
    </section>
  );
